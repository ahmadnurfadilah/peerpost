        ...
        <div className="h-full flex flex-col justify-between">
          <ul className="p-4 space-y-2">
            <li>
              <Link
                href="/dashboard"
                className={`flex items-center gap-3 p-3 rounded-md font-bold text-sm ${pathname === '/dashboard' ? 'bg-gradient-to-r from-lime to-lime/70 text-primary-800 hover:shadow hover:shadow-lime' : 'bg-transparent text-white hover:text-lime'}`}
              >
            ...
            <li>
              <Link
                ...
                id="sec-menu-article"
                className={`flex items-center gap-3 p-3 rounded-md font-bold text-sm ${pathname === '/dashboard/article' ? 'bg-gradient-to-r from-lime to-lime/70 text-primary-800 hover:shadow hover:shadow-lime' : 'bg-transparent text-white hover:text-lime'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 256 256">
                  <path
                    fill="currentColor"
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mt-4">
              <div className="flex items-center gap-3">
                <a href="/settings/profile" className="shrink-0">
                  <img src={`https://source.boringavatars.com/beam/120/1?colors=DEECA3,f4a261,e76f51`} alt="Photo" className="w-8 h-8 rounded-full" />
                </a>
                <div>
